...
const Page = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#EEF7F6]/50 font-fredoka">
      <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md space-y-6">
        ...
        <div>
          <Button
            variant="outline"
            className="w-full mb-4 border border-[#E5E5E5] flex "
          >
            <img src={"./google.svg"} alt="" className=" z-20 h-6 w-6" />
